...
namespace Lab5.Persistence.Migrations
{
    ...
    public partial class FirstMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "CourseClassesRegistration",
                columns: table => new
                {
                    CourseClassId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseClassesRegistration", x => new { x.CourseClassId, x.StudentId });
                    table.ForeignKey(
                        name: "FK_CourseClassesRegistration_CourseClasses_CourseClassId",
                        column: x => x.CourseClassId,
                        principalTable: "CourseClasses",
                        principalColumn: "CourseClassId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseClassesRegistration_Students_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseClassesRegistration_StudentId",
                table: "CourseClassesRegistration",
                column: "StudentId");
        }
